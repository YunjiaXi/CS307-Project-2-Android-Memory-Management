...
static enum page_references page_check_references(struct page *page,
						  ...
						  struct scan_control *sc)
{
	unsigned long referenced_ptes, referenced_page;
	...
	printk(KERN_INFO "index %ld: inactive ref >> 1  ref: %ld\n",page->index, referenced_page);
	...
	//change 6: if new_PG_ref <= 1, try to
			       ...
			       int priority, int file)
{
	...
	while (!list_empty(&l_hold)) {
		...
		//change 8: move page to inactive list if new_PG_ref <= 2^9
